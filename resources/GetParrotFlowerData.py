...
def convert_temperature(rawValue):
   ...
   temperature = 0.00000003044 * pow(rawValueInt, 3.0) - 0.00008038 * pow(rawValueInt, 2.0) + rawValueInt * 0.1149 - 30.449999999999999
...
def convert_Soil(rawValue):
    rawValueInt = rawValue[1] * 255 + rawValue[0]
    soilMoisture = 11.4293 + (0.0000000010698 * math.pow(rawValueInt, 4.0) - 0.00000152538 * math.pow(rawValueInt, 3.0) + 0.000866976 * math.pow(rawValueInt, 2.0) - 0.169422 * rawValueInt);
